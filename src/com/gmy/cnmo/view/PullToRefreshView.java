...
public class PullToRefreshView extends LinearLayout {
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.drop_down_list_header, this, false);

		mHeaderImageView = (ImageView) mHeaderView.findViewById(R.id.drop_down_list_header_image);
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.drop_down_list_footer, this, false);
		mFooterTextView = (TextView) mFooterView.findViewById(R.id.drop_down_list_footer_button);
...
//		int top = getHeight();
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			mHeaderTextView.setText(getResources().getString(
					R.string.drop_down_list_header_release_text));// 释放刷新
			...
			// mHeaderImageView.
			mHeaderTextView.setText(getResources().getString(
					R.string.drop_down_list_header_pull_text));// 下拉刷新
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
			...
			// mFooterImageView.clearAnimation();
			// mFooterImageView.startAnimation(mFlipAnimation);
			mFooterTextView.setText(getResources().getString(
	...
	private void headerRefreshing() {
		...
		mHeaderTextView.setText(getResources().getString(
				R.string.drop_down_list_header_loading_text));// 正在加载
	...
	private void footerRefreshing() {
		...
		mFooterTextView.setText(getResources().getString(
				R.string.drop_down_list_footer_loading_text));// 正在加载
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderTextView.setText("头部完成更新");
	...
	public void onFooterRefreshComplete() {
		setHeaderTopMargin(-mHeaderViewHeight);
		mFooterTextView.setText("尾部完成更新");
